...
// SECURE CODE: Access control - require login for add
requireAuth();
...
<body>
    <main class="main">
        ...
        <form class="form" method="post" enctype="multipart/form-data">
            ...
            <input type="number" id="rating" name="rating" class="form-control" value="<?php echo htmlspecialchars($movie['rating'], ENT_QUOTES, 'UTF-8'); ?>" min="0" max="10" step="0.1" placeholder="e.g. 8.5">
