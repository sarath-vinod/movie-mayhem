...
// VULNERABLE CODE: No access control - anyone can edit if they know the URL
...
<body>
    <main class="main">
        ...
        <form class="form" method="post" enctype="multipart/form-data">
            ...
            <input type="number" id="rating" name="rating" class="form-control" value="<?php echo $movie['rating']; ?>" min="0" max="10" step="0.1">
